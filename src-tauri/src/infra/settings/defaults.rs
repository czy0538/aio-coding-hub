...
pub(super) const SCHEMA_VERSION_ADD_KEYWORD_REVIEW: u32 = 30;
...
pub(super) const DEFAULT_ENABLE_KEYWORD_REVIEW: bool = false;
pub(super) const DEFAULT_KEYWORD_REVIEW_TIMEOUT_SECONDS: u32 = 300;
pub(super) const MAX_KEYWORD_REVIEW_TIMEOUT_SECONDS: u32 = 3600;
